...
import com.link_intersystems.sonnen.client.api.impl.SonnenRestClientFactory;
...
class DefaultSonnenClientTest {
    ...
    void setUp(HttpMockServer httpMockServer) {
        ...
        SonnenClientFactory sonnenClientFactory = SonnenRestClientFactory.getInstance();
        sonnenClient = sonnenClientFactory.create("http://localhost:" + httpMockServer.getPort() + "/", "TOKEN_123");
    }
    ...
    void getLatestdata() throws IOException, SonnenClientException {
        ...
        IcStatus icStatus = latestdata.getIcStatus();
        ...
        MicrogridStatus microgridStatus = icStatus.getMicrogridStatus();
        ...
        DCShutdownReason dcShutdownReason = icStatus.getDCShutdownReason();
        ...
        EclipseLed eclipseLed = icStatus.getEclipseLed();
        ...
        MISCStatusBits miscStatusBits = icStatus.getMISCStatusBits();
        ...
        SetpointPriority setpointPriority = icStatus.getSetpointPriority();
        ...
        SystemValidation systemValidation = icStatus.getSystemValidation();
